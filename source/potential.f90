...
contains
   ...
   subroutine restore_to_default(this)
      ...
      allocate (this%qi(0:this%lmax, 2))
      call g_safe_alloc%report_allocate('potential.qi', this%qi)
      allocate (this%dele(0:this%lmax, 2))
      call g_safe_alloc%report_allocate('potential.dele', this%dele)
