module recursion_plugin_mod
  ...
  public :: copy_psi_b_to_device, copy_hall_to_device, copy_ee_to_device, copy_lsham_to_device
  public :: copy_izero_to_host, copy_iz_to_device
  public :: copy_psi_b_to_host, copy_atemp_b_to_host, copy_b2temp_b_to_host
  public :: run_recursion_step
  interface
    function create_recursion(kk, nmax, lld, nhall, nee, ntype) bind(C, name="create_recursion_")
      import c_int, c_ptr
      integer(c_int), value :: kk, nmax, lld, nhall, nee, ntype
    ...
    subroutine copy_izero_to_host(rec, host_izero) bind(C, name="copy_izero_to_host_")
      import c_ptr
      type(c_ptr), value :: rec
      type(c_ptr), value :: host_izero
    end subroutine copy_izero_to_host

    subroutine copy_iz_to_device(rec, host_iz) bind(C, name="copy_iz_to_device_")
      import c_ptr
      type(c_ptr), value :: rec
      type(c_ptr), value :: host_iz
    end subroutine copy_iz_to_device
